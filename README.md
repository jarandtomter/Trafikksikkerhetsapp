...
3. Legg til Mapbox Access Token i local.properties (kan bruke nåværende token ved testing)
4. Legg til Azure Token i data/ki/AzureOpenAIService.kt (Kontakt jatomter@gmail.com for bruk av token)
5. Bygg prosjektet gjennom "Build > Make Project"
6. Koble til en fysisk Android-enhet via USB eller sett opp en emulator via AVD Manager
7. Kjør appen ved å klikke på den grønne "Run"-knappen
8. Godta alle tillatelser appen ber om ved første oppstart
9. Appen kan teknisk sett kjøre på enheter med API 26+, men vi anbefaler API 31 eller nyere for optimal ytelse
